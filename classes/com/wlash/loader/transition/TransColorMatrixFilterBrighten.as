...
package com.wlash.loader.transition{
	...
	* </p>
	*/
	public class TransColorMatrixFilterBrighten extends EventDispatcher implements ITransEffect{
		 ...
		 */
		public function TransColorMatrixFilterBrighten(second:Number=1) {
		...
		public function trans(obj0:DisplayObject, obj1:DisplayObject):void {
			obj1.visible	=	false;
			TweenLiteClass['to'](obj0, _second*.5, { colorMatrixFilter:{contrast:2, brightness:3}, onComplete:onBrighten, onCompleteParams:[obj1] } );
		}
		
		private function onBrighten(obj1:DisplayObject):void{
			TweenLiteClass['to'](obj1, _second * .5, { colorMatrixFilter: { contrast:1, brightness:1 }, onComplete:onTweenFinish } );
			obj1.visible	=	true;
		}
